    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-5">
          ...
          <Button className="w-full bg-pink-500 text-white" onClick={handleSubmit} disabled={loading || !email || !password}>{mode === 'login' ? 'Continue' : 'Create Account'}</Button>
          ...
          <Button variant="outline" className="w-full flex bg items-center gap-2" onClick={handleGithub} disabled={!isConfigured}>
            <span className="inline-block h-4 w-4">
              <svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">
          ...
          <a href="">  <div className="text-sm text-center ">
            {mode === 'login' ? (
